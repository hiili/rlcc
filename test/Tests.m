classdef Tests < PersistentSingleton
  ...
  properties (Constant)
    ...
    AllTests = [ ...
      struct( 'classname', 'TestTest', 'referenceRevision', 20171005, 'active', false ), ...
      struct( 'classname', 'TestTetris', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisTestingPhases', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisStopConds1', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisStopConds2', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisNacLstd', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisNacLspe', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisNacLspepi', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisNacLspeAvoidTerm', 'referenceRevision', 20171005, 'active', false ), ...
      struct( 'classname', 'TestTetrisCnacLspe', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetrisNacFullTD', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestTetris50k', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestGraphRotorbladeNac', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestGraphHiddenForkOPI', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestGridNac', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestGraphSynthetic', 'referenceRevision', 20171005, 'active', true ), ...
      struct( 'classname', 'TestFeaturizerSynthetic', 'referenceRevision', 20171005, 'active', true ), ...
      ];
