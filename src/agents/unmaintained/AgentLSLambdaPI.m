classdef AgentLSLambdaPI < Agent
  %AGENTLSLAMBDAPI Least-squares lambda policy iteration agent.
  %
  %   ...
  ...
  methods
    ...
    function this = AgentLSLambdaPI( critic, varargin )
      
      this.critic = critic;
      
      args = inputParser;
      args.addParamValue( 'use_advantages', false, @islogical );
  ...
  methods (Access=protected)
    ...
    function this = learn( this, phi_s0, phi_sa0, pi0, a0, r0, phi_s1, phi_sa1, a1 )
      ...
      % update critic
      assert( ~this.useAdvantages );
      this.critic = step( this.critic, phi_s0', zeros(this.sDim, 1), ...
                          r0 + this.critic.gamma * phi_s1 * this.w );
